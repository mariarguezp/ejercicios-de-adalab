...
server.post("/user", (req, res) => {
  console.log(
    "Header param unparametroenlacabecera:",
    req.headers.unparametroenlacabecera
  );
  console.log(
    "Header param unparametroenlacabecera:",
    req.header("unparametroenlacabecera")
  );
  console.log(
    "Header param otro-parametro-de-la-cabecera:",
    parseInt(req.headers["otro-parametro-de-la-cabecera"])
  );
  console.log(
    "Header param otro-parametro-de-la-cabecera:",
